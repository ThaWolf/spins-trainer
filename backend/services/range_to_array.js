...
const { codeRanks, rankCodes, byCodeRankDescending } = require('../utils/htr/core')
...
module.exports = range_to_array
module.exports.reverse = require('./range_to_array.reverse')
